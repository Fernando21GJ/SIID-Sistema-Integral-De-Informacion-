          ...
          <div class="container">
              ...
              <div class="panel panel-default formPanel">
                    <div class="panel-heading bg-color-1 border-color-1">
                       <h3 class="panel-title">Editar nota</h3>
                    </div>
                    <div class="panel-body">
                       <div class="homeContactContent">

              <form action="<?php echo base_url();?>panel/editarnota/update" method="post">
                <div class="form-group">
                  <label for="id_nota"></label>
                  <input type="hidden" id="id_nota" name="id_nota" value="<?php echo $nota->id_nota;?>"/>
                </div>
                <div class="form-group">
                  <label for="nombre">Nombre:</label>
                  <input type="text" id="nombre" class="form-control" name="nombre" value="<?php echo $nota->nombre;?>"/>
                </div>
                <div class="form-group">
                  <label for="nota">Nota:</label>
                  <input type="text" id="nota" class="form-control" name="nota" value="<?php echo $nota->nota;?>"/>
                </div>
                <div class="form-group">
                  <label for="fecha">Fecha:</label>
                  <input type="date" class="form-control" name="date_out" required="required" value="<?php echo $nota->fecha;?>">
                </div>
                <br>
                <div class="media courseList couresListPage">
                  <div class="media-body">
                    <ul class="list-inline btn-sky btnPart">
                      ...
                      <li>    <a type="submit" class="btn btn-primary" href="<?=base_url('principal/'.$this->siid->TAREA_NOTAS.'')?>">Cancelar</a> </li>
                    </ul>
                  </div>
                </div>
              </div>
